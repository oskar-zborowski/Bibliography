...
trait AdmikoHelperTrait
{
    ...
    public function listRouteNames()
    {
        ...
        $skip_pages = array('admins', 'admin_roles', 'admiko_auditable_logs');
        foreach ($allRoutes as $route) {
            if (strpos($route->getName(), 'bibliography.') !== false && strpos($route->getName(), '.index') !== false) {
                $name = str_replace('bibliography.', '', $route->getName());
