...
use App\Models\Bibliography\Admins\AdmikoAuditable;
...
class AdmikoAuditableLogsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("bibliography.admins.admiko_auditable_logs.index")->with(compact('admiko_data', "tableData"));
    }
    ...
    public function show($id)
    {
        ...
        if (auth()->user()->role_id != 1 || !$AuditableLogs) {
            return redirect(route("bibliography.admiko_auditable_logs.index"));
        }
        ...
        $data = $AuditableLogs;
        return view("bibliography.admins.admiko_auditable_logs.view")->with(compact('admiko_data', 'data'));
    }
