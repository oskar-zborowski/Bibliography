 ...
 */
namespace App\Http\Controllers\Bibliography\Auth;
...
class ForgotPasswordController extends Controller
{
    ...
    {
        return view('bibliography.auth.passwords.email');
    }
    ...
    public function sendResetLink(Request $request, Admins $Admins)
    {
        ...
        if ($email) {
            ...
            \Mail::to($email->email)->send(new \App\Http\Controllers\Bibliography\Auth\EmailResetLink($data));
    ...
    public function showResetForm(Request $request, Admins $Admins)
    {
        ...
        if ($token) {
            ...
            return view('bibliography.auth.passwords.reset')->with(compact('reset_token'));
        }
        return redirect(route('bibliography.login'));
    }
