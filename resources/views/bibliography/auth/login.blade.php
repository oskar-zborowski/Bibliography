@extends('bibliography.auth.auth')
@section('content')
    <form method="POST" action="{{ route("bibliography.login") }}" class="needs-validation" novalidate>
        @csrf
        ...
        <small><a href="{{ route("bibliography.password.request") }}">{{ trans('admiko.forgot_pass') }}</a></small>
