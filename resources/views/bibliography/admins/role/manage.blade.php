...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"><a href="{{ route("bibliography.admin_roles.index") }}">{{ trans('admiko.roles_page_title') }}</a></li>
    @if(isset($data))
...
@section('backBtn')
    <a href="{{ route("bibliography.admin_roles.index") }}"><i class="fas fa-angle-left"></i> {{ trans('admiko.page_back_btn') }}</a>
@endsection
@section('content')
                ...
                <div class="form-actions">
                    <div class="row" id="form-group-buttons">
                        ...
                        <div class="secondaryButtons col pt-0 text-end">
                            <a href="{{ route("bibliography.admin_roles.index") }}" class="btn btn-secondary mb-1 mb-sm-0  ms-3 ms-sm-0" role="button">{{ trans('admiko.table_cancel') }}</a>
                        </div>
                    </div>
                </div>
            </div>
