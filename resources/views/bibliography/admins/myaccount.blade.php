...
@section('content')
    <div class="card formPage">
        ...
        <form method="POST" action="{{route('bibliography.myaccount.update')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
            @method('PUT')
            @csrf
            <div class="card-body">
                ...
                <div class="form-actions">
                    <div class="row" id="form-group-buttons">
                        ...
                        <div class="secondaryButtons col pt-0 text-end">
                            <a href="{{ route("bibliography.home") }}" class="btn btn-secondary mb-1 mb-sm-0  ms-3 ms-sm-0" role="button">{{ trans('admiko.table_cancel') }}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form method="POST" action="{{route('bibliography.myaccount.updatepassword')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
            @method('PUT')
            @csrf
            <div class="card-body">
                <div class="form-group row">
