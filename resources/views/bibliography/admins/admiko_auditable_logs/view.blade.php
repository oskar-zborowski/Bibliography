...
@section('breadcrumbs')
    <li class="breadcrumb-item active"><a href="{{ route("bibliography.admiko_auditable_logs.index") }}">{{trans('admiko.auditable_title')}}</a>
    </li>
...
@endsection
@section('backBtn')
    <a href="{{ route("bibliography.admiko_auditable_logs.index") }}"><i
